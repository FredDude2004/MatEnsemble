...
Create an workflow with `RADICAL-Pilot` that reproduces this adaptive scientific campaign.
...
I also want information about how `RADICAL-Pilot` ran the workflow
