...
Create an workflow with `Maestro Workflow Conductor` that reproduces this adaptive scientific campaign.
...
I also want information about how `Maestro Workflow Conductor` ran the workflow
